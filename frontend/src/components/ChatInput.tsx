...
export default function ChatInput({ onSendMessage, isLoading, disabled = false }: ChatInputProps) {
  ...
  return (
    <form onSubmit={handleSubmit} className="glass-card p-4">
      <div className="flex items-end space-x-4">
        ...
        <div className="flex-1 relative">
          <textarea
            ...
            disabled={isDisabled}
            rows={1}
            className="w-full glass-input rounded-xl px-4 py-3 text-white placeholder-white/50 resize-none focus:outline-none focus:ring-2 focus:ring-blue-400/50 transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed"
      ...
      {/* Help Text */}
      <div id="input-help" className="mt-2 flex items-center justify-between text-xs text-white/40">
